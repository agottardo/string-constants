...
Italian translation for Racket

|#

(module italian-string-constants "string-constant-lang.rkt"
 ;;; when translating this constant, substitute name of actual language for `English'
 (is-this-your-native-language "L'italiano è la tua lingua madre?")

 (are-you-sure-you-want-to-switch-languages
  "Questo cambierà la lingua dell'interfaccia grafica, dovrai quindi riavviare DrRacket. Sei sicuro?")

 (interact-with-drscheme-in-language "Interagisci con DrRacket in italiano")

 ;; these two should probably be the same in all languages excepet English.
 ;; they are the button labels (under macos and windows, respectively)
 ;; that go the with the string above.
 (accept-and-quit "Accetta ed esci")
 (accept-and-exit "Accetta ed esci")
 ...
 (untitled-n "Senza titolo ~a")
 (warning "Attenzione")
 (error "Errore")
 (close "Chiudi") ;; as in, close an open window or tab. must match close-menu-item
 ...
 (stop "Interrompi")   
 (&stop "&Interrompi") ;; for use in button and menu item labels, with short cut.
 (are-you-sure-delete? "Sei sicuro di voler cancellare ~a?") ;; ~a is a filename or directory name
 (are-you-sure-replace? "Sei sicuro di voler sostituire ~a?") ;; ~a is a filename or directory name
 (ignore "Ignora")
 (revert "Torna indietro")

 ;; label for a generic check box, often supported on dialogs
 ;; that ask a binary choice of the user. If checked, the
 ;; dialog isn't going to be shown again.
 ;; One version for always using the current choice:
 (dont-ask-again-always-current "Non chiederlo nuovamente (usa sempre la scelta corrente)")
